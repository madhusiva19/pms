...
evaluation_bp.add_url_rule("/<evaluation_id>", view_func=service.get_evaluation, methods=["GET"])
evaluation_bp.add_url_rule("/<eval_id>/reject", view_func=service.reject_evaluation, methods=["POST"])
