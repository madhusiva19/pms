...
from .notification_routes import notification_bp, notifications_alias_bp
from .objectives_routes import objectives_bp
...
def register_blueprints(app):
    ...
    app.register_blueprint(notifications_alias_bp)
