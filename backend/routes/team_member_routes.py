...
team_member_bp.add_url_rule("/<int:member_id>", view_func=service.get_team_member, methods=["GET"])
team_member_bp.add_url_rule("/<int:member_id>/status", view_func=service.update_member_status, methods=["PUT"])
