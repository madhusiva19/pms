...
approval_bp.add_url_rule("/<int:approval_id>", view_func=service.get_approval, methods=["GET"])
approval_bp.add_url_rule("/<int:approval_id>", view_func=service.update_approval, methods=["PUT"])
