    ...
    <div className={styles.shell}>
      ...
      <aside className={styles.sidebar}>
        ...
        <nav className={styles.sideNav}>
          ...
          <button
            ...
            onClick={() => router.push("/country-admin/dashboard")}
          >
        ...
        <div className={styles.sideFooter}>
          <div className={styles.profileRow}>
            ...
            <div className={styles.profileText}>
              ...
              <div className={styles.profileRole}>country admin</div>
            </div>
          </div>
          <button
      ...
      <main className={styles.main}>
        <div className={styles.breadcrumb}>
          <span className={styles.crumbLink} onClick={() => router.push("/country-admin/dashboard")}>
            Home
          </span>
          ...
          <div className={styles.card}>
            ...
            {approvalStatus === "pending" && (
              <div style={{
                ...
                Your achievement is awaiting review by the HQ Admin. You cannot edit it until a decision is made.
              </div>
            )}
            ...
            <div className={styles.tipBox}>
              ...
              <div className={styles.tipText}>
                Keep it short and measurable! Your achievement will be reviewed by the HQ Admin before it is recorded.
              </div>
            </div>
          </div>
        </section>
