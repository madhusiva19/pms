...
const BACK_PATH = '/dept-admin/potential-assessment/supervisor-review';
...
export default function DeptAdminReconsiderationReviewPage() {
  ...
  return (
    <div className="flex flex-col gap-8 max-w-[1225px] mx-auto w-full px-8 py-6 pb-10">
      <Breadcrumb items={[
        { label: 'Dept Admin', href: '/dept-admin' },
        { label: 'Potential Assessment', href: '/dept-admin/potential-assessment' },
        { label: 'Reconsideration', href: '/dept-admin/potential-assessment/reconsideration' },
                  ...
                  {pillarItems.map((item, idx) => {
                    ...
                    return (
                      <tr key={item.id} className="border-b border-[#F1F5F9] last:border-0 divide-x divide-[#E5E7EB]">
                        ...
                        <td className="px-4 py-4 align-top text-center"><ComponentRating value={item.self_rating} /></td>
