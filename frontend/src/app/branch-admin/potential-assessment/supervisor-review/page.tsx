              ...
              {reconSubs.length > 0 && (
                <div className="flex flex-col gap-3 mt-2">
                  <div className="pb-3 border-b border-[#E5E7EB]">
                    ...
                    <p className="text-[13px] text-[#64748B]">These dept admins have requested a reconsideration of their assessment result.</p>
                  </div>
                  <div className="bg-white rounded-xl border border-[#E5E7EB] overflow-hidden">
                    <table className="w-full border-collapse">
                      <thead>
                      ...
                      <tbody>
                        {reconSubs.map((sub) => (
                          <tr key={sub.id} className="border-b border-[#F1F5F9] hover:bg-[#FAFAFA] transition-colors">
                            ...
                            <td className="px-5 py-4">
                              <button type="button"
                                onClick={() => router.push(`/branch-admin/potential-assessment/reconsideration/${sub.assessment_id}`)}
