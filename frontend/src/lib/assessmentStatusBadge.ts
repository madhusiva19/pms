...
export const statusBadge: Record<AssessmentStatus, { label: string; cls: string }> = {
  ...
  reconsideration_requested: { label: 'Reconsideration Requested', cls: 'bg-[#FEF3C7] text-[#92400E] border-[#FDE68A]' },
  reconsideration_rejected:  { label: 'Reconsideration Rejected', cls: 'bg-[#FEE2E2] text-[#DC2626] border-[#FCA5A5]' },
};
