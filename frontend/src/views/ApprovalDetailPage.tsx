  ...
  useEffect(() => {
    ...
    const fetchApprovalDetails = async () => {
      ...
      try {
        ...
        const memberId = approvalData.team_member_id || approvalData.member_id || approvalData.memberId || routeMemberId || approvalData.employee_id || approvalData.employeeId;
        ...
        const resolvedMember: TeamMember = {
          ...memberData,
