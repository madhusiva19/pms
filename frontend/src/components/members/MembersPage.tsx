              ...
              {filteredMembers.map((member) => (
                ...
                >
                  <div className={viewStyles.v091}>
                    <div className={viewStyles.v092}>
                      {member.name.charAt(0)}
                    </div>
                    <div className={viewStyles.v093}>
                      <h3 className={viewStyles.v094}>{member.name}</h3>
                      <p className={viewStyles.v095}>{formatRole(member.role)}</p>
                    </div>
                  </div>
                  ...
                  {member.status && (
                    <div className={viewStyles.v100}>
                      <span className={`${viewStyles.v118} ${(viewStyles as Record<string,string>)[getStatusBadgeClass(member.status)]}`}>
