  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      {/* TABLE — supervisor review grid: Component | Appraisee Rating | Appraisee Example | Your Rating | Your Justification
          side-by-side layout lets supervisor see the appraisee's self-rating and example
                    ...
                    {isReadOnly ? (
                      ...
                      <div className="flex gap-1">
                        {/* BUTTONS — H / M / L supervisor rating toggles (one set per component row)
                            supervisor must explicitly rate each component; blue badge style
        ...
        <div className="flex items-center justify-between">
          <div className="flex gap-2">
            {activeTab !== PILLAR_KEYS[0] && (
              ...
              //  allows supervisor to go back and correct a rating before final submission
            ...
            {activeTab !== PILLAR_KEYS[PILLAR_KEYS.length - 1] && (
              ...
              // guides the supervisor through all 3 pillars in sequence before the Submit button becomes reachable
              <button onClick={() => setActiveTab(PILLAR_KEYS[PILLAR_KEYS.indexOf(activeTab) + 1])}
          ...
          {/* BUTTON — "Submit Review" (opens confirmation modal)
             disabled until all 9 ratings AND justifications are filled; an incomplete
          ...
          <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full mx-4 p-6 flex flex-col gap-5">
            ...
            <div className="flex gap-3 justify-end">
              {/* BUTTON — "Cancel" (dismiss confirmation modal without submitting)
                  gives the supervisor a chance to re-check ratings before the irreversible finalisation */}
              ...
              {/* BUTTON — "Finalise Assessment" (triggers supervisor-submit API call)
                 once clicked the backend calculates pillar ratings and Overall Potentiality,
