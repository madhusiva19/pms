...
const hqAdminNavItems: NavItem[] = [
  ...
  { name: 'Training Log', href: '/hq-admin/training-passport', icon: LucideFileBarChart },
...
const countryAdminNavItems: NavItem[] = [
  ...
  { name: 'Training Log', href: '/country-admin/training-passport', icon: LucideFileBarChart },
...
const branchAdminNavItems: NavItem[] = [
  ...
  { name: 'Training Log', href: '/branch-admin/training-passport', icon: LucideFileBarChart },
...
const deptAdminNavItems: NavItem[] = [
  ...
  { name: 'Training Log', href: '/dept-admin/training-passport', icon: LucideFileBarChart },
...
const subDeptAdminNavItems: NavItem[] = [
  ...
  { name: 'Training Log', href: '/sub-dept-admin/training-passport', icon: LucideFileBarChart },
...
const employeeNavItems: NavItem[] = [
  ...
  { name: 'Training Log', href: '/employee/training-passport', icon: LucideFileBarChart },
